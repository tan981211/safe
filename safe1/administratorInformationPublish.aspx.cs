...
namespace safe1
{
    public partial class administratorInformationPublish : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            releaseCard1.releaseCard_Title = "收水费";
        ...
        {
            this.Response.Redirect("administratorInformationPublish_UpdateNotice.aspx");
        }

        protected void Unnamed_ServerClick2(object sender, EventArgs e)
        {
            this.Response.Redirect("administratorInformationPublish_Examine.aspx");
        }
    }
}